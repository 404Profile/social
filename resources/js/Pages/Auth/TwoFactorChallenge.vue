    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            <template v-if="! recovery">
                Пожалуйста, подтвердите доступ к своей учётной записи, введя код аутентификации, который был предоставлен вашим приложением для проверки подлинности.
            </template>

            <template v-else>
                Пожалуйста, подтвердите доступ к своей учётной записи, введя один из ваших кодов экстренного восстановления.
            </template>
        </div>
